...
class List_Page_Revisions extends Ability_Definition {
	...
	protected function ability(): array {
		return array(
			'name' => 'zoltiq/list-page-revisions',
			'args' => array(
				'label'               => __( 'Get Page Revisions', 'zoltiq-agents' ),
				'description'         => __( 'List all stored revisions for a page by ID. Autosaves are hidden by default; pass include_autosaves=true to surface them.', 'zoltiq-agents' ),
