...
class Deactivate_Plugin extends Ability_Definition {
	...
	protected function ability(): array {
		return array(
			'name' => 'zoltiq/deactivate-plugin',
			'args' => array(
				'label'               => __( 'Deactivate Plugin', 'zoltiq-agents' ),
				'description'         => __( 'Deactivate an active WordPress plugin by name, slug, or partial match. Works in recovery mode; only updates the active-plugins option and does not load the plugin file.', 'zoltiq-agents' ),
