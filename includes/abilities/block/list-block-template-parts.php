...
class List_Block_Template_Parts extends Ability_Definition {
	...
	protected function ability(): array {
		return array(
			'name' => 'zoltiq/list-block-template-parts',
			'args' => array(
				'label'               => __( 'List Block Template Parts', 'zoltiq-agents' ),
				'description'         => __( 'Lists block template parts across the database (wp_template_part), the active theme\'s /parts/*.html, the parent theme, and installed plugin /parts dirs. Filter by source, theme_type, plugin_slug, area, or exact slug.', 'zoltiq-agents' ),
				...
				'input_schema'        => array(
					...
					'properties'           => array(
						...
						'area'            => array(
							...
							'default'     => '',
							'description' => __( 'Filter by template-part area. Only applies to DB rows; file rows are returned regardless.', 'zoltiq-agents' ),
						),
						'slug'            => array(
							'type'        => 'string',
							'default'     => '',
